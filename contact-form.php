...
<body class="relative custom_cursor">
    ...
    <div id="preloader">
        ...
        <div
            ...
            <img src="assets/img/site-logo.svg" alt="docroch">
        </div>
    </div>
    <!-- App Preloader End -->
    ...
    <!-- App Start -->
    <div class="relative pt-10 docroch__app max-xl:pt-18">
        <div
        ...
        <div class="max-lg:px-4">
            ...
            <div class="fixed top-0 left-0 right-0 z-50 flex items-center justify-between p-2 px-3 bg-white/10 mobile-menu-bar sm:px-6 backdrop-blur-md xl:hidden">
                <div class="text-lg font-medium name">
                    <a href="http://127.0.0.1:5500/" class="flex items-center gap-2 text-black dark:text-white">
            ...
            <div id="mobilemenusidebar" class="mobile-menu fixed top-0 -right-full w-full max-w-mobilemenu bg-flashWhite dark:bg-nightBlack z-999 h-full xl:hidden transition-all duration-300 [&.is-menu-open]:right-0 py-12 px-8 overflow-y-scroll"></div>
            <!-- Mobile Menu Sidebar End -->

            <!-- Sidebar Profile Start -->
            <div
                class="w-full mx-auto docroch__sidebar__wrapper xl:fixed xl:top-1/2 xl:left-4 2xl:left-14 xl:-translate-y-1/2 md:max-w-sidebar xl:max-2xl:max-w-xs z-999">

                <div class="p-3 max-xl:mb-3 overflow-hidden docroch__sidebar bg-white dark:bg-nightBlack rounded-2xl">
                    <div class="mx-4 mt-12 text-center user-info lg:mx-6">
                        ...
                        <h6 class="mb-1 text-lg font-semibold text-black dark:text-white name">Soheil Abbasnia</h6>
                    ...
                    <div class="px-4 py-5 lg:py-6 lg:px-6 rounded-2xl md:px-8 bg-flashWhite dark:bg-metalBlack">
                        ...
                        <div class="flex items-center justify-between my-4 space-x-4 skills_circle *:space-y-2 *:text-center">
                            <div class="progressCircle">
                                <div class="relative w-12 h-12 circle" data-percent="75" data-circlefill="#00BC91" data-circleempty="#777777">
                                    <div class="absolute inset-0 text-[13px] font-medium label flex-center">75%</div>
                                </div>
                                <p class="text-[13px] font-normal dark:font-light text-black dark:text-white/90">Python</p>
                            </div>
                            <div class="progressCircle">
                                <div class="relative w-12 h-12 circle" data-percent="60" data-circlefill="#00BC91" data-circleempty="#777777">
                                    <div class="absolute inset-0 text-[13px] font-medium label flex-center">60%</div>
                                </div>
                                <p class="text-[13px] font-normal dark:font-light text-black dark:text-white/90">ML</p>
                            </div>
                            <div class="progressCircle">
                                <div class="relative w-12 h-12 circle" data-percent="75" data-circlefill="#00BC91" data-circleempty="#777777">
                                    <div class="absolute inset-0 text-[13px] font-medium label flex-center">75%</div>
                                </div>
                                <p class="text-[13px] font-normal dark:font-light text-black dark:text-white/90">Front-End</p>
                            </div>
                            <div class="progressCircle">
                                ...
                                <p class="text-[13px] font-normal dark:font-light text-black dark:text-white/90">Wordpress</p>
                            </div>
                        </div>
                        <!-- <div class="mt-6">
            ...
            <div class="docroch__nav__wrapper bg-snowWhite dark:bg-power__black max-xl:hidden fixed top-1/2 -translate-y-1/2 right-4 2xl:right-14 z-999 flex items-center flex-col gap-4 border border-platinum dark:border-metalBlack rounded-4xl px-2.5 py-4">
            ...
            <!-- Main Content Start -->
            <div class="docroch__contentBox relative mx-auto max-w-container xl:max-2xl:max-w-65rem">
                ...
                <div class="py-3.5 max-w-content xl:max-2xl:max-w-50rem max-xl:mx-auto xl:ml-auto">
                    ...
                    <div class="px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl lg:p-10 2xl:p-13">
                        ...
                        <div>
                            <?php
                                $webmaster_email = "soheilabbasnia@gmail.com";
                            ...
                            <p>I appreciate that you took the time to send the message. Your Message has been sent to
                                the Admin Panel.</p>
                            <br>
                            <p>I am getting back to you soon.</p>
                            <br>
                            <a href="index.html"
            ...
            <!-- Footer Start -->
            <footer class="mx-auto docroch__contentBox max-w-container xl:max-2xl:max-w-65rem">
                <div class="footer-container text-center py-6 max-w-content xl:max-2xl:max-w-50rem max-xl:mx-auto xl:ml-auto">
                    <p>
                        Copyright by
                        <a href="#" class="transition-colors">Soheil Abbasnia</a>
                    </p>
                </div>
            </footer>
            <!-- Footer End -->
